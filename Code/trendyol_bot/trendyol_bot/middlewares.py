...
class RandomUserAgentMiddleware:
    ...
    def process_request(self, request, spider):
        # Listeden rastgele bir kimlik (ID) seç
        random_agent = random.choice(self.user_agents)
        
        # Seçilen kimliği isteğin (request) başlığına (header) yerleştir
        request.headers['User-Agent'] = random_agent
        spider.logger.debug(f"Kılık Değiştirildi -> Yeni Kimlik: {random_agent}")


class TrendyolBotSpiderMiddleware:
...
class TrendyolBotDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
