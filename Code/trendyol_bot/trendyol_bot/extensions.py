...
TR_PREFIXES = (
    ...
    "78.166.", "78.167.", "78.168.", "78.169.",
    "85.100.", "85.101.", "85.102.", "85.103.", "85.104.", "85.105.",
    "85.106.", "85.107.",
    "176.88.", "176.89.", "176.220.", "176.221.",
    ...
    "79.123.",
    # Vodafone TR
    "88.228.", "88.229.", "88.230.", "88.231.", "88.232.", "88.233.",
    "88.234.", "88.235.", "88.247.", "88.255.",
...
HEDEF_HAVUZ    = 500 # 150 idi baya yavaş
DOLUM_ESIGI    = 15
...
class LiveProxyUpdater:
    ...
    def _inject_to_scrapy(self, result: dict):
        ...
        ordered = result["tr"] * 3 + result["foreign"]
